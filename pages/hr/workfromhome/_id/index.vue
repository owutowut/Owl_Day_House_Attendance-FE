    ...
    <div class="grid grid-cols-2 gap-4 mb-4">
      <div class="flex bg-white p-10 rounded-lg text-left font-kanit border border-gray19 space-x-6">
        <div class="self-center">
          <img :src="workfromhome.profile" class="rounded-full" width="126px" height="126px">
        </div>
        <div class="self-center">
          <p class="text-xl text-blue2">{{ workfromhome.name }}</p>
          <p class="text-base text-gray6 mb-2">{{ workfromhome.department }}</p>
          <div>
            <span class="bg-blue rounded-2xl text-white text-center py-1 px-4">{{ workfromhome.tag }}</span>
          </div>
        </div>
      </div>
      ...
      <div class="col-span-3 space-y-4">
        <div class="grid grid-cols-3 col-span-full flex gap-4 text-gray23">
          ...
          <div class="bg-white p-4 rounded-lg text-left space-y-1">
            ...
            <p class="border border-gray12 rounded-md bg-gray22 w-full px-2 py-1">{{workfromhome.noofdays}}</p>
          </div>
        </div>
          ...
          <div class="bg-white p-10 rounded-lg text-left space-y-4 text-gray23 w-full">
            <div class="flex space-x-2 overflow-x-hidden">
              ...
              <div class="space-y-4 w-full">
                ...
                <textarea rows="10" cols="40" disabled class="w-full border border-gray12 rounded-md bg-gray22 p-4" v-model="workfromhome.details"></textarea>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="col-span-1 space-y-4">
        <div class="bg-white p-4 rounded-lg">
          <div class="text-center grid grid-cols-2 divide-x justify-center divide-gray13">
            <div>
              <Span class="mr-3 text-base text-blue font-semibold">Punch In</Span>
              <div class="mr-4 ml-1 mt-1 text-gray23">
                <p class="border border-gray12 rounded-md bg-gray22 w-full px-2 py-1">{{workfromhome.punchin}}</p>
              </div>
            </div>
            <div>
              <Span class="ml-2 text-base text-blue font-semibold">Punch Out</Span>
              <div class="mr-1 ml-4 mt-1 text-gray23">
                <p class="border border-gray12 rounded-md bg-gray22 w-full px-2 py-1">{{workfromhome.punchout}}</p>
              </div>
            </div>
          </div>
        </div>
